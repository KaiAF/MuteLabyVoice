/**
 * @Author https://docs.labymod.net/pages/server/protocol/protocol/
 */
...
public class LabyModProtocol {
     ...
     */
    public static void sendLabyModMessage(Player player, String key, JsonElement messageContent) throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        PacketPlayOutCustomPayload payloadPacket = new PacketPlayOutCustomPayload(MuteLabyVoice.LABY_CHANNEL_NAME, pds);
